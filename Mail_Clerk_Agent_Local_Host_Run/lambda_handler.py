...
DEPARTMENT_EMAILS = {
    "Finance & Billing Department": FORWARD_TARGET,
    "IT / Technical Support": FORWARD_TARGET,
    "Customer Service": FORWARD_TARGET
}
    ...
    try:
        ...
        for item in results:
            ...
            email_content = (
                ...
                f"{incoming_body if incoming_body else item.get('summary', '')}\n"
                f"----------------------------------------"
            )
